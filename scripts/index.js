		...
		return {
			...
			projects: [
				...
				},
				{
					name: 'rate',
					title: 'Rate my Plate',
					tag: 'RESTAURANT VOTING APP',
					detail: 'A platform that helps 1337’s school restaurant gather feedback on their daily menus and gives students the ability to vote for the meal. This platform was made for both campuses in Benguerir and Khouribga.',
				},
				{
					name: 'send',
					title: 'Emails Sender',
